...
pub fn Sidebar(
    ...
    rsx! {
        aside { 
            class: "w-48 bg-white/80 backdrop-blur-sm p-4 flex flex-col border-r border-gray-200 transition-all duration-300",
            div { class: "sidebar-content",
                nav { id: "main-nav",
                    ul { class: "space-y-2 items-center list-none p-0 m-0",
                        li { class: "list-none",
                            a { 
